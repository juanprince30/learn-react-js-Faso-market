export default function Product(){
    return(
        <div className="card bg-base-100 shadow-sm w-80 h-100">
            <figure>
                <img
            ...
            <div className="card-body h-40">
                ...
                <div className="flex items-center justify-between w-full">
                    ...
                    <div>
                        <button className="btn btn-primary">Buy Now <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
